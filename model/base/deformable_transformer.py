...
class DAttentionBaseline(nn.Module):
    ...
    def __init__(
        ...
        if self.q_h == 13 or self.q_w == 13 or self.q_h == 25 or self.q_w == 25:
            kk = 5
        elif self.q_h == 7 or self.q_w == 7 or self.q_h == 12 or self.q_w == 12:
            kk = 3
        elif self.q_h == 24 or self.q_w == 24 or self.q_h == 48 or self.q_w == 48:
            kk = 7
        elif self.q_h == 50 or self.q_w == 50 or self.q_h == 96 or self.q_w == 96:
            kk = 9
